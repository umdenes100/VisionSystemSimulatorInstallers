...
- [Moving off of the Simulator](#moving-off-of-the-simulator)
...
![alt text](https://github.com/umdenes100/VisionSystemSimulatorInstallers/blob/master/img/Security_Warning.png "Security Warning Message")

Step 1) Open the general settings window.

General Settings Window:
![alt text](https://github.com/umdenes100/VisionSystemSimulatorInstallers/blob/master/img/General_Settings.png "General Settings")
...
![alt text](https://github.com/umdenes100/VisionSystemSimulatorInstallers/blob/master/img/Security_Window.png "Security Options")
